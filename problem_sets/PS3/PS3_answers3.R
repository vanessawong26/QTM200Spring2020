...
alpha4
# alpha = -4.860 x 10^(-18)
# linear model: y = -4.860 x 10^(-18) + 0.2569x
# check work
...
# write the prediction equation
# yhat = 0.4486 + 0.0355xdifflog + 0.2569xpresvote


# what is it in this output that is identical to the output in Q4? why do you think this is the case?
# the slope of the regression of voteshare on presvote is the same as the slope of of the regression of Q1 residuals on Q2 residuals.
# i think this is the case because the regression of Q1 residuals on Q2 residuals tells us how much variation in presvote 
# *and* voteshare is not explained by difflog. in both cases, the slopes describe the relationship between voteshare and presvote, while
# holding difflog constant. As such, they have the same slope. 
