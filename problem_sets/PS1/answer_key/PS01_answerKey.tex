...
\begin{figure}[h!]\centering
	...
	\caption{\footnotesize Scatterplot of relationship between $Y, X_1, X_2$, and $X_3$.}
		\label{fig:plot_3b}
	\includegraphics[width=.85\textwidth]{../../../graphics/plot_3b.pdf}
\end{figure}
...
\begin{figure}[h!]\centering
	...
	\label{fig:plot_3c}
	\includegraphics[width=.75\textwidth]{../../../graphics/plot_3c.pdf}
\end{figure}
...
\begin{figure*}[h!]
	...
	\begin{subfigure}[t]{0.5\textwidth}
		...
		\includegraphics[width=0.99\textwidth]{../../../graphics/plot_3d1.pdf}
	\end{subfigure}%
	\begin{subfigure}[t]{0.5\textwidth}
		\centering
			\caption{\footnotesize Differentiating between region by color and shape.}
		\includegraphics[width=0.99\textwidth]{../../../graphics/plot_3d2.pdf}
